/* ============================================================
   NATURE CARDS — procedural fractal illustrations for fractal.html
============================================================ */
(function () {
  ...
  function drawCoast(canvas) {
    ...
    let pts = [
      { x: -0.05, y: 0.62 }, { x: 0.20, y: 0.50 },
      { x: 0.45, y: 0.58 }, { x: 0.65, y: 0.46 },
      { x: 0.85, y: 0.55 }, { x: 1.05, y: 0.48 },
    ];
    const rng = seedRng(7);
    let sigma = 0.06;
  ...
  function drawQuake(canvas) {
    ...
    const bursts = [
      { center: 0.30, mag: 0.92 }, { center: 0.65, mag: 0.65 },
      { center: 0.15, mag: 0.40 }, { center: 0.78, mag: 0.35 },
      { center: 0.50, mag: 0.30 }, { center: 0.45, mag: 0.20 },
      { center: 0.85, mag: 0.18 }, { center: 0.10, mag: 0.20 },
    ];
    bursts.forEach(b => {
